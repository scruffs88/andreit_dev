...
var getDegree = function getDegree(radian) {
  return radian / Math.PI * 180;
};

var getRadian = function getRadian(degrees) {
  return degrees * Math.PI / 180;
};

var debounce = function debounce(object, eventType, callback) {
  var timer;
...
var threeStart = function threeStart() {
  initThree();
  initCamera();
  initLight();
...
var LightSphereObj = function LightSphereObj() {
  this.id = 0;
  this.r = 80;
  this.x = 0;
  this.y = 0;
...
var setEvent = function setEvent() {
  ...
  var eventTouchStart = function eventTouchStart(x, y) {
    judgeRaycastSphere = true;
  };

  var eventTouchMove = function eventTouchMove(x, y) {
    mousemoveX = x;
    mousemoveY = y;
  ...
  var eventTouchEnd = function eventTouchEnd() {
    accelerating = false;
...
var resizeRenderer = function resizeRenderer() {
...
/***/ 2:
/*!***********************************!*\
  !*** multi ./src/js/particles.js ***!
  \***********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/drupalvm/andreit_1.0_dev/docroot/themes/custom/andreit/src/js/particles.js */"./src/js/particles.js");
