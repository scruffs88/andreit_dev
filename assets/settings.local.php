...
if (isset($_SERVER['HTTP_HOST'])) {
  switch ($_SERVER['HTTP_HOST']) {
    case (preg_match("/(?:^local\.|\.local\.)/i", $_SERVER['HTTP_HOST']) ? TRUE : FALSE) :
    ...
    default:
    case (preg_match("/(?:^work\.|\.work\.)/i", $_SERVER['HTTP_HOST']) ? TRUE : FALSE) :
      // Configure config split directory
      $server = @$_SERVER['HTTP_HOST'];
      $config['config_split.config_split.whitelist']['status'] = TRUE;
      $config['config_split.config_split.blacklist']['status'] = TRUE;
    ...
    case (preg_match("/(?:^stage\.|\.stage\.)/i", $_SERVER['HTTP_HOST']) ? TRUE : FALSE) :
      // Configure config split directory
      $server = @$_SERVER['HTTP_HOST'];
      $config['config_split.config_split.whitelist']['status'] = TRUE;
      $config['config_split.config_split.blacklist']['status'] = TRUE;
    ...
    case (preg_match("/(?:^live\.|\.live\.)/i", $_SERVER['HTTP_HOST']) ? TRUE : FALSE) :
      // Configure config split directory
      $config['config_split.config_split.whitelist']['status'] = TRUE;
      $config['config_split.config_split.blacklist']['status'] = TRUE;
      $config['config_split.config_split.local']['status'] = FALSE;
