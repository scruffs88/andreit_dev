Feature: Check the inbox for emails using the testing@drupalcoders.com email

  @javascript @tools @google
  Scenario: Login to the testing@drupalcoders.com email.
    Given I go to "https://accounts.google.com" website
     When I fill in "testing@drupalcoders.com" for "Email"
      And I press "Next"
